...
@LastEditTime: 2020-05-26 18:40:15
...
eval_batches, num_eval_batches, num_eval_samples = get_batch(hp.eval_features_path, hp.eval_labels_path, 100000 , 10000, shuffle=False)
...
age_hat, eval_summaries = m.eval(sparse_features, dense_features, labels)
...
with tf.Session() as sess:
    ...
    for i in tqdm(range(_gs, total_steps+1)):
        ...
        if _gs and _gs % num_train_batches == 0:
            ...
            calc_metric(sess, age_hat, labels)
