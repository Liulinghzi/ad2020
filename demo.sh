###
 ...
 # @LastEditTime: 2020-05-26 17:57:46
...
CUDA_VISIBLE_DEVICES=1 python3 train.py  --train_features_path ../../5-8/train_features.pkl  --train_labels_path ../../5-8/train_labels.pkl --vocab_list ../../5-8/vocab_size_list.pkl --num_heads 8 --d_model 64,16,64,32 --num_blocks 3 --d_ff 256
