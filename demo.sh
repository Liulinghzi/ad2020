###
 ...
 # @LastEditTime: 2020-05-13 10:35:40
...
CUDA_VISIBLE_DEVICES=1 python3 train.py  --train_features_path ../../5-8/train_features.pkl  --train_labels_path ../../5-8/train_labels.pkl --vocab_list ../../5-8/vocab_size_list.pkl --num_heads 2 --d_model 64 --num_blocks 3 --d_ff 512\
